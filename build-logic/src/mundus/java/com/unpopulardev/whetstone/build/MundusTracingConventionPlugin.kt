...
/**
 * Present-mode twin of the `com.unpopulardev.whetstone.mundus` convention plugin: applies the real
 ...
 * modules apply `id("com.unpopulardev.whetstone.mundus")` unconditionally.
 *
...
class MundusTracingConventionPlugin : Plugin<Project> {
    ...
    override fun apply(target: Project) {
        ...
        target.extensions.configure(MundusExtension::class.java) {
            ...
            includePackages.set(listOf("com.unpopulardev.whetstone"))
