...
/**
 * No-Mundus twin of the `com.deliveryhero.whetstone.mundus` convention plugin, compiled into
 ...
 * modules apply `id("com.deliveryhero.whetstone.mundus")` unconditionally regardless of the flag.
 */
