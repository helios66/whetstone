...
import com.unpopulardev.whetstone.activity.ActivityComponent
...
import com.unpopulardev.whetstone.event.GlobalAndroidComponentListener
import com.unpopulardev.whetstone.event.InjectedComponent
import com.unpopulardev.whetstone.service.ContributesServiceInjector
import com.unpopulardev.whetstone.service.ServiceComponent
import com.unpopulardev.whetstone.view.ViewComponent
...
public object Whetstone {
    ...
    public fun <T : Any> fromActivity(activity: Activity): T {
        ...
        return activityComponents.getOrPut(activity) {
            fromApplication<ActivityComponent.Factory>(app)
                .create(activity)
        } as T
    }
    ...
    public fun inject(activity: Activity) {
        ...
        val injector = fromActivity<ActivityComponent>(activity)
            .membersInjectorMap[activity::class] as? MembersInjector<Activity>
    ...
    public fun inject(service: Service) {
        ...
        val injector = fromApplication<ServiceComponent.Factory>(app)
            .create(service)
    ...
    public fun inject(view: View) {
        ...
        val injector = fromActivity<ViewComponent.Factory>(activity)
            .create(view)
